...
var appConfig = {
    ...
    baseURL: 'https://bxae6rw9vf.execute-api.us-east-1.amazonaws.com/api'
};

var mainApp = angular.module('musicManagerApp', ['ngRoute', 'ngSanitize', 'ngCookies', 'ngProgress', 'pascalprecht.translate']);

mainApp.config(['$routeProvider', '$locationProvider', '$httpProvider', '$translateProvider',
...
//	$locationProvider.hashPrefix('!');
    ...
    .run(function ($rootScope, $location, $cookieStore, $http, ngProgress) {
        ...
        $rootScope.logout = function () {
            ngProgress.start();
            $http.get(appConfig.baseURL + '/logout')
        ...
        $rootScope.getUser = function () {
            ngProgress.start();
            $http.get(appConfig.baseURL + '/user/me')
                .success(function (data) {
                    $rootScope.user = data;
                    ngProgress.complete();
                })
...
mainApp.factory('globalConfig', function () {
    return {
